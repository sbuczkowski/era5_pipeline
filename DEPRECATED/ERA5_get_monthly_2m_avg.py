...
scratch_dir = "/umbc/isilon/rs/strow/asl/ERA5_avg/INCOMING"
...
######
target = os.path.join(scratch_dir, '%04d-%02d_2m.nc' % (year, month))
print(baseDateStr, target)

ERA5Queries.get_2m_monthly_avg(cds, year, month, target, config)
######
